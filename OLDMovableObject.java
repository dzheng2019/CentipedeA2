...
class Dart extends AMoveableObject {
  ...
  IList<CentipedeHead> transformCentipedes(IList<CentipedeHead> centipedes, Board b) {
    /* Template:
     * Same as class template:
     * Parameter:
     * centipedes - IList<CentipedeHead>
     ...
     * centipedes.length() - int 
     */
    return new ChangeCentipedeHeadsAtLocation(this.location, b).apply(centipedes);
  }
}
