...
//  int unit = 40;
//  int row = 2;
//  OLDBoard board = new OLDBoard(row, 2);
//
...
//
//  OLDBoard board2x2 = new OLDBoard(2, 2);
//  OLDBoard board0x0 = new OLDBoard(0, 0);
//  OLDBoard board2x2D = new OLDBoard(tileGrid2);
//
...
//    t.checkExpect(board2x2.randomBoard(false, 0, new Random(123)), new OLDBoard(tileGrid1));
//    t.checkExpect(board2x2.randomBoard(false, 10, new Random(1234)), new OLDBoard(tileGrid2));
...
//    t.checkExpect(board2x2.changeAtLocation(new Posn(-20, -20), true), new OLDBoard(tileGrid1));
//    t.checkExpect(board2x2.changeAtLocation(new Posn(60, 20), false), new OLDBoard(tileGrid2));
...
//    t.checkExpect(board2x2.clickAtLocation(new Posn(-1, -1), false), new OLDBoard(tileGrid1));
//    t.checkExpect(board2x2.clickAtLocation(new Posn(1, 1), true), new OLDBoard(tileGrid2));
